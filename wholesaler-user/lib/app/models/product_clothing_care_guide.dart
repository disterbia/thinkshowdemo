class ProductClothingCareGuide {
  bool? isHandWash;
  bool? isDryCleaning;
  bool? isWaterWash;
  bool? isSingleWash;
  ...
  factory ProductClothingCareGuide.fromJson(Map<String, dynamic> json) {
    return ProductClothingCareGuide(
